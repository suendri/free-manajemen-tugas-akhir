...
$valueCari = isset($_SESSION['usercari']) ? $_SESSION['usercari'] : NULL;
?>
    ...
    <div class="col-md-6">
        <form method="POST" action="<?php echo URL; ?>user/userCari">
            <div class="input-group">
                <input type="text" name="katakunci" value="<?php echo $valueCari; ?>" class="form-control" pattern="[a-zA-Z0-9\s]+" placeholder="Cari User" required="">
                 <span class="input-group-btn">
                    <input class="btn btn-primary" type="submit" value="Cari">
                    <a class="btn btn-primary" href="<?php echo URL; ?>user">Semua</a>
                </span>
            </div>
        </form>
    </div>
...
<div class="alert alert-info">Hasil Pencarian User dengan kata kunci <b>"<?php echo $_SESSION['usercari']; ?>"</b></div>
<div class="clear"></div>
