...
<h2>Pengangkatan Pembimbing</h2>
<div class="row">
    <div class="col-md-6">
        <form method="POST" action="<?php echo URL; ?>pembimbing/cari">
            <div class="input-group">
                <input type="text" name="katakunci" value="" class="form-control" pattern="[a-zA-Z0-9\s]+" placeholder="Cari Nomor Induk atau Nama" required="">
